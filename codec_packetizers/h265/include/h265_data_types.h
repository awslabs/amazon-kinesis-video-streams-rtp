...
#define HEVC_NALU_HEADER_F_MASK        0x80    // 10000000
#define HEVC_NALU_HEADER_F_LOCATION       7

// Second byte
#define HEVC_NALU_HEADER_LAYER_ID_MASK   0xF8  // 11111000
#define HEVC_NALU_HEADER_LAYER_ID_LOCATION  3

#define HEVC_NALU_HEADER_TID_MASK        0x07  // 00000111
 ...
 * +---------------+
 */
#define FU_HEADER_SIZE                 3    // 2 bytes NAL header + 1 byte FU header

#define FU_INDICATOR_OFFSET            0    // The NAL unit header starts at the beginning (offset 0).
#define FU_HEADER_OFFSET               2    // The FU header starts after the 2-byte NAL unit header.
#define FU_PAYLOAD_OFFSET              3    // The actual payload starts after both headers (2 + 1 = 3).
...
#define AP_NAL_HEADER_SIZE           2    // NAL unit header size in aggregation unit
